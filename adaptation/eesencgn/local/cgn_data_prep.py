...
new_utt = ''
new_wav = ''
os.system('mkdir -p '+data_folder+'/'+suffix)
os.system('mkdir -p '+data_folder+'/'+'lang_phn')
...
os.system('env LC_ALL=C sort -o '+data_folder+'/'+suffix+'/text'+' '+data_folder+'/'+suffix+'/text')
os.system('env LC_ALL=C sort -o '+data_folder+'/'+suffix+'/segments'+' '+data_folder+'/'+suffix+'/segments')
os.system('env LC_ALL=C sort -o '+data_folder+'/'+suffix+'/wav.scp'+' '+data_folder+'/'+suffix+'/wav.scp')
os.system('env LC_ALL=C sort -o '+data_folder+'/'+suffix+'/utt2spk'+' '+data_folder+'/'+suffix+'/utt2spk')
os.system('utils/utt2spk_to_spk2utt.pl '+data_folder+'/'+suffix+'/utt2spk'+' > '+data_folder+'/'+suffix+'/spk2utt')
